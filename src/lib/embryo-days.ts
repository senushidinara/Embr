...
export const DAYS: DayEntry[] = [
  {
    day: 1, week: 1, stageId: "day1",
    title: "Fertilization",
    headline: "Sperm fuses with the secondary oocyte in the ampulla of the fallopian tube.",
    size: "0.10 mm", cellCount: "1 cell · 2 pronuclei", phase: "Zygote — pre-cleavage",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "PLCζ / IP3 / Ca²⁺", ligand: "Sperm PLCζ (injected)", receptor: "IP3 receptor on ooplasmic ER", effect: "Ca²⁺ oscillations → cortical granule exocytosis, meiotic resumption" },
      { pathway: "Juxtacrine adhesion", ligand: "IZUMO1 (sperm)", receptor: "JUNO (oocyte plasma membrane)", effect: "Irreversible sperm–oocyte membrane fusion" },
    ],
    clinical: "This is conception. Clinical gestational age is counted from LMP, so Day 1 of embryology ≈ Week 2 GA.",
  },
  {
    day: 2, week: 1, stageId: "day1",
    title: "First Cleavage",
    headline: "Pronuclei fuse (syngamy) and the zygote splits into 2 blastomeres.",
    size: "0.10 mm", cellCount: "2 cells", phase: "Cleavage begins",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Cell-cycle control", ligand: "—", receptor: "—", effect: "CDK1/Cyclin B activity drives first cleavage; MAPK signalling resets after syngamy" },
      { pathway: "Ciliary transport (maternal)", ligand: "Progesterone", receptor: "Tubal epithelial PR", effect: "Regulates ciliary beat frequency propelling zygote toward uterus" },
    ],
  },
  {
    day: 3, week: 1, stageId: "day3",
    title: "Morula & Compaction",
    headline: "8–16 blastomeres tightly pack into a mulberry-like solid ball.",
    size: "0.15 mm", cellCount: "8 → 16 blastomeres", phase: "Compaction",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Hippo (YAP/TAZ)", ligand: "Cell contact / polarity cues", receptor: "Merlin–LATS1/2 kinase cassette", effect: "Outer cells: YAP nuclear → Cdx2 ON → trophectoderm. Inner cells: YAP cytoplasmic → Oct4/Nanog → ICM" },
      { pathway: "Cadherin juxtacrine adhesion", ligand: "E-cadherin", receptor: "E-cadherin (homophilic)", effect: "Compaction, polarization, tight-junction assembly" },
    ],
  },
  {
    day: 4, week: 1, stageId: "day3",
    title: "Late Morula",
    headline: "The morula reaches the uterine cavity — cavitation is imminent.",
    size: "0.15 mm", cellCount: "~32 cells", phase: "Pre-cavitation",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "FGF / MAPK", ligand: "FGF4 from epiblast progenitors", receptor: "FGFR2 on primitive-endoderm precursors", effect: "Salt-and-pepper segregation of epiblast vs primitive endoderm inside the ICM" },
      { pathway: "Ion transport (not classic signalling)", ligand: "—", receptor: "Na⁺/K⁺-ATPase + aquaporin-3/9", effect: "Vectorial water flux → nascent blastocoele" },
    ],
  },
  {
    day: 5, week: 1, stageId: "day5",
    title: "Early Blastocyst",
    headline: "A hollow blastocoele cavity forms — first true lineage split.",
    size: "0.20 mm", cellCount: "~120 cells", phase: "Cavitation",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "FGF/ERK", ligand: "FGF4 (epiblast)", receptor: "FGFR2 (primitive endoderm)", effect: "GATA6 ON → primitive-endoderm identity; low FGF → NANOG ON → epiblast" },
      { pathway: "Hippo", ligand: "Contact/polarity cues", receptor: "LATS→YAP", effect: "Reinforces TE (YAP-nuclear) vs ICM (YAP-cytoplasmic)" },
    ],
    clinical: "This is the stage transferred in IVF and the source of embryonic stem cells (harvested from the ICM).",
  },
  {
    day: 6, week: 1, stageId: "day5",
    title: "Hatching Blastocyst",
    headline: "The blastocyst escapes its zona pellucida.",
    size: "0.20 mm", cellCount: "~150 cells", phase: "Hatching",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Protease cascade", ligand: "Trophectoderm proteases (strypsin, cathepsins)", receptor: "Zona glycoproteins (substrate)", effect: "Local zona digestion → hatching hole" },
      { pathway: "LIF/STAT3 (uterine receptivity)", ligand: "Maternal LIF", receptor: "LIFR/gp130 on trophectoderm & luminal epithelium", effect: "STAT3 activation licenses adhesion competence" },
    ],
  },
  {
    day: 7, week: 1, stageId: "day5",
    title: "Apposition & Adhesion",
    headline: "The blastocyst orients ICM-first and sticks to the uterine wall.",
    size: "0.20 mm", cellCount: "~200 cells", phase: "Implantation begins",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Integrin adhesion", ligand: "Osteopontin, fibronectin (uterine)", receptor: "αvβ3 integrin (trophoblast)", effect: "Firm attachment of blastocyst to endometrium" },
      { pathway: "HB-EGF / ErbB", ligand: "HB-EGF (endometrium)", receptor: "ErbB1/ErbB4 (trophoblast)", effect: "Trophoblast activation, adhesion, proliferation" },
      { pathway: "hCG / LHCGR", ligand: "hCG (syncytiotrophoblast)", receptor: "LHCGR (corpus luteum)", effect: "Progesterone maintenance → uterus stays receptive" },
    ],
    clinical: "First moment a home pregnancy test would detect hCG (~8–10 days post-conception).",
  },
  {
    day: 8, week: 2, stageId: "day8",
    title: "Bilaminar Disc",
    headline: "The ICM splits into two layers: epiblast and hypoblast.",
    size: "0.25 mm", cellCount: "thousands", phase: "Two-layer embryo",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Nodal (TGF-β family)", ligand: "Nodal (epiblast)", receptor: "ActRIIB / ALK4 + Cripto co-receptor", effect: "SMAD2/3 → maintains pluripotent epiblast identity" },
      { pathway: "BMP", ligand: "BMP4 (extraembryonic ectoderm)", receptor: "BMPR1/2", effect: "SMAD1/5/8 → restricts epiblast, promotes extraembryonic fates" },
    ],
  },
  {
    day: 9, week: 2, stageId: "day8",
    title: "Lacunae Appear",
    headline: "Blood-filled spaces open in the syncytiotrophoblast.",
    size: "0.30 mm", cellCount: "—", phase: "Uteroplacental circulation begins",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "VEGF / VEGFR (maternal side)", ligand: "VEGF from decidua", receptor: "VEGFR2 on maternal endothelium", effect: "Vessel remodeling that facilitates lacunar filling" },
      { pathway: "hCG amplification", ligand: "hCG", receptor: "LHCGR (corpus luteum + syncytiotrophoblast autocrine)", effect: "Sustains progesterone, promotes syncytial growth" },
    ],
  },
  {
    day: 10, week: 2, stageId: "day8",
    title: "Implantation Complete",
    headline: "Embryo fully embedded — a fibrin plug seals the surface.",
    size: "0.35 mm", cellCount: "—", phase: "Deep implantation",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "IL-11 / gp130", ligand: "Decidual IL-11", receptor: "IL-11Rα/gp130 (trophoblast)", effect: "STAT3 → regulated trophoblast invasion" },
      { pathway: "TGF-β brake", ligand: "TGF-β (decidua)", receptor: "TGF-βR (trophoblast)", effect: "Limits invasion depth — prevents placenta accreta" },
    ],
    clinical: "Implantation bleeding, if it occurs, happens around now — sometimes mistaken for a light period.",
  },
  {
    day: 11, week: 2, stageId: "day8",
    title: "Primitive Uteroplacental Circulation",
    headline: "Maternal blood begins to trickle through the lacunar network.",
    size: "0.4 mm", cellCount: "—", phase: "Circulation established",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "FGF / FGFR", ligand: "FGF from trophoblast", receptor: "FGFR on extraembryonic mesoderm", effect: "Mesenchymal proliferation & villus core formation" },
      { pathway: "BMP", ligand: "BMP4", receptor: "BMPR1/2", effect: "Specifies extraembryonic mesoderm and blood-island precursors" },
    ],
  },
  {
    day: 12, week: 2, stageId: "day8",
    title: "Extraembryonic Coelom",
    headline: "Extraembryonic mesoderm splits — chorionic cavity opens.",
    size: "0.4 mm", cellCount: "—", phase: "Chorionic cavity forms",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "BMP", ligand: "BMP2/4", receptor: "BMPR", effect: "Splits extraembryonic mesoderm into somatic vs splanchnic domains" },
      { pathway: "FGF", ligand: "FGF2/4", receptor: "FGFR", effect: "Maintains extraembryonic mesoderm proliferation" },
    ],
  },
  {
    day: 13, week: 2, stageId: "day8",
    title: "Secondary Yolk Sac",
    headline: "The primary yolk sac collapses and a smaller secondary yolk sac forms.",
    size: "0.45 mm", cellCount: "—", phase: "Yolk-sac remodeling",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "BMP4 → hematopoiesis", ligand: "BMP4 (splanchnic mesoderm)", receptor: "BMPR (yolk-sac mesoderm)", effect: "Specifies blood-island progenitors (hemangioblasts)" },
      { pathway: "Indian hedgehog (Ihh)", ligand: "Ihh (yolk-sac endoderm)", receptor: "Patched (adjacent mesoderm)", effect: "Promotes vasculogenesis and early hematopoiesis" },
    ],
  },
  {
    day: 14, week: 2, stageId: "day8",
    title: "End of Week 2 — Prechordal Plate",
    headline: "Bilaminar disc stable, cranial pole marked, streak about to appear.",
    size: "0.5 mm", cellCount: "—", phase: "Pre-gastrulation",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Nodal", ligand: "Nodal (posterior epiblast)", receptor: "ActRIIB / ALK4 + Cripto", effect: "Posteriorly high → primitive streak site; anterior AVE Cerberus/Lefty inhibit Nodal to fix cranial identity" },
      { pathway: "Wnt", ligand: "Wnt3", receptor: "Frizzled/LRP5-6", effect: "β-catenin nuclear → posterior identity, streak induction" },
    ],
    clinical: "The 14-day rule — most jurisdictions cap in-vitro embryo research just before the primitive streak forms.",
  },
  {
    day: 15, week: 3, stageId: "day16",
    title: "Primitive Streak Emerges",
    headline: "A midline groove appears on the caudal epiblast — gastrulation begins.",
    size: "1.0 mm", cellCount: "—", phase: "Gastrulation initiates",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Wnt/β-catenin", ligand: "Wnt3", receptor: "Frizzled / LRP5-6", effect: "Nuclear β-catenin → Brachyury (T) → primitive-streak/mesoderm program" },
      { pathway: "Nodal", ligand: "Nodal", receptor: "ActRIIB/ALK4 + Cripto → SMAD2/3", effect: "Specifies node and axial mesendoderm" },
      { pathway: "FGF", ligand: "FGF8 (streak)", receptor: "FGFR1 (epiblast)", effect: "MAPK activation → E-cadherin down, Snail up → EMT" },
      { pathway: "BMP", ligand: "BMP4 (posterior)", receptor: "BMPR", effect: "Restricts streak to caudal midline; blocks anterior EMT" },
    ],
  },
  {
    day: 16, week: 3, stageId: "day16",
    title: "Three Germ Layers Form",
    headline: "Epiblast cells stream through the streak to build meso- and endoderm.",
    size: "1.5 mm", cellCount: "Ecto · Meso · Endo", phase: "Trilaminar embryo",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Snail/Slug (Zn-finger TFs)", ligand: "Induced by Wnt/Nodal/FGF", receptor: "—", effect: "Repress E-cadherin → drive EMT at the streak" },
      { pathway: "Nodal (high)", ligand: "Nodal", receptor: "ActRIIB/ALK4 + Cripto", effect: "High → endoderm (Sox17, FoxA2); low → mesoderm" },
      { pathway: "FGF", ligand: "FGF8", receptor: "FGFR1", effect: "Sustains streak, Brachyury expression, mesoderm migration" },
    ],
    clinical: "A persistent streak → sacrococcygeal teratoma. Failure to regress or duplicate → conjoined twins.",
  },
  {
    day: 17, week: 3, stageId: "day16",
    title: "Mesoderm Subdivides",
    headline: "The middle layer splits into paraxial, intermediate and lateral plate mesoderm.",
    size: "1.6 mm", cellCount: "—", phase: "Mesoderm patterning",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "BMP gradient", ligand: "BMP4 (lateral, high) → (medial, low)", receptor: "BMPR", effect: "High BMP → lateral plate; intermediate → intermediate mesoderm; low (antagonized by Noggin/Chordin from notochord) → paraxial" },
      { pathway: "FGF/Wnt (paraxial)", ligand: "FGF8, Wnt3a", receptor: "FGFR1, Frizzled", effect: "Maintain presomitic mesoderm; drive segmentation clock" },
      { pathway: "VEGF", ligand: "VEGF (endoderm)", receptor: "VEGFR2 (mesoderm)", effect: "Endothelial specification in blood islands" },
    ],
  },
  {
    day: 18, week: 3, stageId: "day16",
    title: "Notochordal Process",
    headline: "A hollow rod of mesoderm extends forward from the node.",
    size: "1.8 mm", cellCount: "—", phase: "Axial induction",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Sonic hedgehog (SHH)", ligand: "SHH (notochord)", receptor: "Patched (releases repression of Smoothened) → GLI TFs", effect: "Ventralizes neural tube (floor plate, motor neurons); acts as a morphogen with cholesterol-anchored gradient" },
      { pathway: "BMP antagonism", ligand: "Noggin, Chordin, Follistatin (node)", receptor: "Sequester BMP4/7", effect: "Removes BMP repression → default neural fate in dorsal ectoderm" },
      { pathway: "FGF", ligand: "FGF8", receptor: "FGFR1", effect: "Cooperates with BMP inhibition to stabilize neural induction" },
    ],
  },
  {
    day: 19, week: 3, stageId: "day21",
    title: "Neural Plate Broadens",
    headline: "The neural plate widens cranially into the future brain.",
    size: "1.9 mm", cellCount: "—", phase: "Neural plate stage",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "SHH (ventral)", ligand: "SHH (notochord/floor plate)", receptor: "Patched → Smoothened → GLI", effect: "Ventral neural patterning (floor plate, motor neurons)" },
      { pathway: "BMP/Wnt (dorsal)", ligand: "BMP4/7, Wnt1/3a (surface ectoderm)", receptor: "BMPR, Frizzled", effect: "Dorsal neural fates (roof plate, sensory interneurons) & neural crest priming" },
      { pathway: "BMP2 → heart field", ligand: "BMP2 (pharyngeal endoderm)", receptor: "BMPR (cardiogenic mesoderm)", effect: "Induces Nkx2.5/GATA4 → cardiac lineage" },
    ],
  },
  {
    day: 20, week: 3, stageId: "day21",
    title: "Neural Folds & First Somites",
    headline: "Neural folds rise and the first pair of somites appears.",
    size: "2.0 mm", cellCount: "1–4 somite pairs", phase: "Neurulation",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Notch segmentation clock", ligand: "Delta-like (DLL1/3)", receptor: "Notch1 → HES7 oscillations", effect: "Times ~90-min somite budding cycles" },
      { pathway: "FGF8 / Wnt3a gradient", ligand: "FGF8, Wnt3a (tail)", receptor: "FGFR1, Frizzled", effect: "Maintains presomitic mesoderm; retreat of gradient sets somite boundary" },
      { pathway: "Retinoic acid (opposing gradient)", ligand: "RA (anterior somites)", receptor: "RAR/RXR", effect: "Antagonizes FGF/Wnt → permits somite MET and maturation" },
      { pathway: "Non-canonical Wnt / PCP", ligand: "Wnt5a, Wnt11", receptor: "Frizzled (+ Vangl/Celsr)", effect: "Convergent extension → neural plate narrowing/elongation" },
    ],
  },
  {
    day: 21, week: 3, stageId: "day21",
    title: "Neural Tube Closes",
    headline: "Neural folds fuse at the neck — the CNS becomes a closed tube.",
    size: "2.5 mm", cellCount: "~7 somite pairs", phase: "CNS formed",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "BMP → Wnt → Snail/FoxD3", ligand: "BMP4/Wnt1 (dorsal ectoderm)", receptor: "BMPR / Frizzled", effect: "Induces neural crest identity and EMT" },
      { pathway: "PCP (non-canonical Wnt)", ligand: "Wnt5a/Wnt11", receptor: "Frizzled + Vangl2 / Celsr / Dishevelled → Rho/Rac", effect: "Convergent extension → neural tube closure; VANGL mutations cause human NTDs" },
      { pathway: "Folate one-carbon metabolism", ligand: "Folate (dietary)", receptor: "Folate receptors / MTHFR", effect: "Supplies methyl groups for DNA/histone methylation; deficiency → failed closure" },
    ],
    clinical: "Failed cranial closure = anencephaly; failed caudal closure = spina bifida. Prevented by peri-conceptional folic acid.",
  },
  {
    day: 22, week: 4, stageId: "day21",
    title: "Heart Starts Beating",
    headline: "Paired heart tubes fuse into a single beating primitive heart.",
    size: "2.8 mm", cellCount: "~14 somite pairs", phase: "First circulation",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "BMP2 → Nkx2.5/GATA4", ligand: "BMP2 (endoderm)", receptor: "BMPR (cardiogenic mesoderm)", effect: "Specifies cardiomyocyte identity" },
      { pathway: "Wnt inhibition (canonical)", ligand: "Dkk1, Crescent (anterior)", receptor: "LRP5/6 blockade", effect: "Anterior canonical Wnt OFF is required for heart induction" },
      { pathway: "FGF8", ligand: "FGF8 (pharyngeal endoderm)", receptor: "FGFR", effect: "Sustains second heart field for outflow tract" },
    ],
  },
  {
    day: 23, week: 4, stageId: "day21",
    title: "Cranial Neuropore Closes",
    headline: "The head end of the neural tube seals shut.",
    size: "3.0 mm", cellCount: "~20 somite pairs", phase: "Brain vesicles forming",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Nodal / Lefty / Pitx2 (L–R axis)", ligand: "Nodal (left), Lefty (midline barrier)", receptor: "ActRIIB/ALK4 + Cripto → Pitx2", effect: "Left-sided Pitx2 drives asymmetric heart looping and visceral situs" },
      { pathway: "SHH (midline)", ligand: "SHH", receptor: "Patched → GLI", effect: "Midline barrier prevents left signals crossing right; also patterns forebrain (holoprosencephaly if lost)" },
      { pathway: "BMP / TGF-β (endocardial EMT)", ligand: "BMP2, TGF-β2", receptor: "BMPR/TGF-βR", effect: "Induces EMT of AV endocardial cells to seed valve mesenchyme" },
    ],
  },
  {
    day: 24, week: 4, stageId: "day28",
    title: "Pharyngeal Arches 1–2",
    headline: "The first two neck ridges appear on either side of the pharynx.",
    size: "3.2 mm", cellCount: "~22 somite pairs", phase: "Face & neck patterning",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Hox code", ligand: "Retinoic acid gradient", receptor: "RAR/RXR", effect: "Nested Hox expression assigns arch identity to migrating crest" },
      { pathway: "Endothelin-1 / EDNRA", ligand: "ET-1 (arch ectoderm/endoderm)", receptor: "EDNRA (arch crest)", effect: "Ventral (mandibular) arch identity — loss → mandibular hypoplasia" },
      { pathway: "FGF8 / BMP4 / SHH", ligand: "FGF8, BMP4, SHH (pharyngeal epithelia)", receptor: "Respective receptors on arch mesenchyme", effect: "Pattern arch cartilages, muscles, teeth" },
    ],
  },
  {
    day: 25, week: 4, stageId: "day28",
    title: "Caudal Neuropore Closes",
    headline: "The tail end of the neural tube seals — the embryo folds into a C-shape.",
    size: "3.5 mm", cellCount: "~25 somite pairs", phase: "Body folding",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "SHH (gut endoderm → mesenchyme)", ligand: "SHH (endoderm)", receptor: "Patched (mesenchyme)", effect: "Radial patterning of gut wall; regional specification (foregut/midgut/hindgut)" },
      { pathway: "Wnt/β-catenin (posterior)", ligand: "Wnt3a", receptor: "Frizzled", effect: "Posterior identity, hindgut/cloaca specification" },
      { pathway: "BMP/Noggin", ligand: "BMP4 vs Noggin", receptor: "BMPR", effect: "Dorso-ventral patterning of body wall and gut" },
    ],
    clinical: "Failed caudal neuropore closure → myelomeningocele (open spina bifida) at the lumbosacral level.",
  },
  {
    day: 26, week: 4, stageId: "day28",
    title: "Upper Limb Buds Appear",
    headline: "Small paddles of mesenchyme bulge out at cervical/thoracic level.",
    size: "3.7 mm", cellCount: "~28 somite pairs", phase: "Limb induction",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "FGF10 ↔ FGF8 (proximo-distal)", ligand: "FGF10 (mesenchyme) → FGF8 (AER)", receptor: "FGFR2b (AER) / FGFR2c (mesenchyme)", effect: "Positive feedback loop drives progressive outgrowth (shoulder→hand)" },
      { pathway: "SHH from ZPA (antero-posterior)", ligand: "SHH", receptor: "Patched → GLI3 processing", effect: "Digit identity gradient (thumb vs pinky); ectopic SHH → polydactyly" },
      { pathway: "Wnt7a (dorso-ventral)", ligand: "Wnt7a (dorsal ectoderm)", receptor: "Frizzled → Lmx1b", effect: "Dorsal limb identity (nail vs palm)" },
      { pathway: "BMP", ligand: "BMP2/4/7", receptor: "BMPR", effect: "Interdigital apoptosis, joint formation" },
    ],
  },
  {
    day: 27, week: 4, stageId: "day28",
    title: "Lower Limb Buds Appear",
    headline: "The paired lower limb buds emerge, ~1 day behind the arms.",
    size: "3.8 mm", cellCount: "—", phase: "Limbs symmetric",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "Tbx4 / Pitx1 (hindlimb identity)", ligand: "Upstream Hox9-13, RA", receptor: "—", effect: "Specifies hindlimb-specific morphology" },
      { pathway: "FGF/SHH/Wnt (limb)", ligand: "FGF10↔FGF8, SHH, Wnt7a", receptor: "FGFR, Patched, Frizzled", effect: "Same three-axis outgrowth loop as forelimb, delayed by ~24 h" },
      { pathway: "BMP → lens induction", ligand: "BMP4/7 (optic vesicle)", receptor: "BMPR (surface ectoderm)", effect: "Sox2/Pax6 → lens placode; loss → anophthalmia" },
    ],
    clinical: "Thalidomide (1957–1961) hit hardest between days 20–36, when limb buds are most vulnerable — producing phocomelia.",
  },
  {
    day: 28, week: 4, stageId: "day28",
    title: "End of Week 4 — Organogenesis",
    headline: "A curved C-shaped embryo with beating heart, brain vesicles, and limb buds.",
    size: "4.0 mm", cellCount: "Millions", phase: "Organogenesis peak",
    whatHappens:
    ...
    signalingPathways: [
      { pathway: "SHH", ligand: "SHH", receptor: "Patched → GLI", effect: "Midline, gut, limb, neural tube patterning" },
      { pathway: "FGF family", ligand: "FGF8/10", receptor: "FGFRs", effect: "Limb outgrowth, brain patterning, branching morphogenesis" },
      { pathway: "Wnt (canonical + PCP)", ligand: "Wnts", receptor: "Frizzled ± LRP", effect: "Axis, kidney, gut, neural tube closure via PCP" },
      { pathway: "TGF-β / BMP / Nodal", ligand: "BMP2/4, TGF-β, Nodal", receptor: "BMPR/ALK", effect: "L–R asymmetry, cushion EMT, dorsoventral patterning" },
    ],
    clinical: "Weeks 3–8 = embryonic period = maximum teratogen sensitivity. Alcohol, isotretinoin, valproate, and rubella cause structural birth defects if exposure occurs now.",
  },
];
